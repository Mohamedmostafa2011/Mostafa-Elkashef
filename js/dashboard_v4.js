...
async function _renderTabInternal(tabName) {
    ...
    try {
        ...
        if (validSections.includes(tabName)) {
            ...
            contentHtml = `
                ${breadcrumbHtml}
                <div class="flex flex-col md:flex-row justify-between items-center mb-8 fade-in gap-4 sticky top-20 z-50 bg-slate-50 dark:bg-slate-900 py-4 shadow-sm border-b border-slate-200 dark:border-slate-800">
